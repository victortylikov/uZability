			...
			<article class="grid_18 alpha" id="article_main_part">
				<section class="section_article" id="post1">
					...
					<p class="section_new">30 ноября в Минске (конференц-зал
						...
						России, Беларуси, ближнего и дальнего зарубежья. Среди
						докладчиков: Виталий Фридман (Шеф-редактор Smashing Magazine,
					...
					<p class="paragraph">У слушателей будет возможность получить
						...
						вопросы. Среди тем выступлений: адаптивный дизайн, проектирование
						и дизайн мобильных приложений и игр, особенности процесса
						проектирования в больших и средних компаниях, мысли и мнения
