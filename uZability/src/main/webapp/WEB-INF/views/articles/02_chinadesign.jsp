				...
				<section class="section_article" id="post2">
					...
					<ul id="conclusion">
						...
						<li>Китайцы активно пользуются встроенными чат-окнами для
							...
							мессенджер QQ.</li>
						<p class="paragraph">
							<strong>Совет тут один:</strong>
							правильно оценивайте аудиторию вашего будущего сайта. Я уже
							приводил пример с «шанхайскими хипстерами» и «провинциальными
							домохозяйками». Если вы делаете сайт для более взрослой
							аудитории, то вам нужно соответствовать не перегибая палку. На
							сайтах для молодых и продвинутых можно не бояться
							экспериментировать и использовать западные практики. Одно точно:
							если у вас свой интернет-бизнес, то позаботьтесь о том, чтобы
							пользователи могли с вами связаться в один клик и получить ответ
							на свой вопрос в течение нескольких минут. Китайцы этим
