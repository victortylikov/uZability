				...
				<section class="section_book" id="post1">
					<header class="book_name">
						...
						<div class="english_title">
							<p class="">Designing Web Interfaces</p>
						</div>
					...
					<p class="p_short_review">Авторы - специалисты по
						проектированию пользовательских интерфейсов - предлагают более 75
						шаблонов проектирования взаимодействия для создания собственных
						удобных и привлекательных веб­приложений. Приводимые шаблоны
						иллюстрируют шесть ключевых принципов проектирования, позволяющих
						в полной мере использовать возможности современных веб­технологий
						и обеспечить эффективность процесса взаимодействия с
						пользователем. Обсуждается и ряд антишаблонов, которых следует
						избегать при проектировании интерфейсов.</p>
					<p class="next_paragraph_annotation">Для наглядности изложения
						каждый шаблон сопровождается конкретным примером действующего
						сайта. Большим подспорьем при чтении книги послужат цветные версии
						иллюстраций, которые можно скачать с сайта издательства либо
						воспользоваться галереей иллюстраций оригинального издания по
						адресу <a href="http://www.flickr.com/photos/designingwebinterfaces/">http://www.flickr.com/photos/designingwebinterfaces/</a>.</p>
					<p class="next_paragraph_annotation">Издание содержит всю
						необходимую дизайнеру и разработчику информацию для принятия
						правильных решений по созданию или обновлению интерактивного сайта
						или насыщенного веб­приложения. Представленные в книге шаблоны
						послужат прекрасным дополнением к инструментарию и полезным
						справочным материалом как новичку, так и опытному специалисту.</p>
				</section>
